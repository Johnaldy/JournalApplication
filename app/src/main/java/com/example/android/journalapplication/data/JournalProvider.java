...
public class JournalProvider extends ContentProvider {
    ...
    static {
        ...
        // of the pets table.
        sUriMatcher.addURI(JournalContract.CONTENT_AUTHORITY, JournalContract.PATH_JOURNAL, JOURNALS);
        ...
        sUriMatcher.addURI(JournalContract.CONTENT_AUTHORITY, JournalContract.PATH_JOURNAL + "/#", JOURNAL_ID);
    }
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case JOURNALS:
                // For the JOURNALS code, query the pets table directly with the given
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        if (title == null) {
            throw new IllegalArgumentException("Entry requires a title");
        }
    // Check that the content is not null
        String content = values.getAsString(JournalEntry.COLUMN_TITLE);
        if (content == null) {
            throw new IllegalArgumentException("Entry requires content");
        }
